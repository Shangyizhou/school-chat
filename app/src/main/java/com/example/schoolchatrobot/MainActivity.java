package com.example.schoolchatrobot;
...
/**
 * MainActivity负责展示常见的功能
 * GuideActivity -> LoginActivity -> MainActivity
 *
 * MainActivity底部直接四个lineraout，对应切换到四个不同的fragment，星球 广场 聊天 我的 StarFragment SquareFragment ChatFragment MeFragment
 */
